...
| **Objetivos:** | Fábio trabalha como advogado em um escritório que representa clientes de alto nível aquisitivo e decidiu utilizar a categoria uber black do aplicativo como opção viável para andar em carros de custo alto sem tem gastos de manutenção, mantendo o conforto. |
...
| **Objetivos:** | Paulo trabalha como mecânico e utiliza através de seus funcionários o serviço de 
uber bag para receber e enviar peças delicadas e precisas em horários flexíveis. |
